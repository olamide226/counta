...
void main() {
  group('TranscriptSegment', () {
    test('fromDeepgramJson correctly parses Nova-3 websocket result payload', () {
      final jsonPayload = {
        'type': 'Results',
        'is_final': true,
        'speech_final': true,
          ...
          'alternatives': [
            {
              ...
              'confidence': 0.985,
              'words': [
                {'word': "i'm", 'start': 1.25, 'end': 1.50, 'confidence': 0.99},
                {'word': 'rich', 'start': 1.55, 'end': 1.85, 'confidence': 0.98},
                {'word': 'in', 'start': 1.90, 'end': 2.05, 'confidence': 0.97},
                {'word': 'wisdom', 'start': 2.10, 'end': 2.65, 'confidence': 0.99},
              ]
            }
          ]
        }
